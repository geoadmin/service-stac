...
password into the environment, using the `export` bash command, before running the script.
...
a dummy asset file for testing multipart uploads. The script takes the file size (in MB and as an integer value)  unzipped dummy
