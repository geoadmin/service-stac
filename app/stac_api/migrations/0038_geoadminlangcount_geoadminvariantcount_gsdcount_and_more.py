    ...
    operations = [
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash='e71a979f25093c48b1c2c43bb91863dc28ad7f6a',
                    operation='UPDATE',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    func=
                    "\n        asset_instance = OLD;\n\n        related_collection_id = (\n            SELECT collection_id FROM stac_api_item\n            WHERE id = asset_instance.item_id\n        );\n\n        UPDATE stac_api_gsdcount\n        SET count = count-1\n        WHERE collection_id = related_collection_id\n            AND value = asset_instance.eo_gsd;\n\n        RAISE INFO\n            'gsdcount (collection_id, value) (% %) count updated, due to asset.name=% update.',\n            related_collection_id, asset_instance.eo_gsd, asset_instance.name;\n\n        RETURN asset_instance;\n        ",
                    hash='54bb140046ce82c8789bcab5589db790d009167f',
                    operation='DELETE',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash='fd2f73f2428accabf50adfca09ea8d80c572f94e',
                    operation='UPDATE',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    func=
                    "\n        asset_instance = OLD;\n\n        related_collection_id = (\n            SELECT collection_id FROM stac_api_item\n            WHERE id = asset_instance.item_id\n        );\n\n        UPDATE stac_api_geoadminlangcount\n        SET count = count-1\n        WHERE collection_id = related_collection_id\n            AND value = asset_instance.geoadmin_lang;\n\n        RAISE INFO\n            'geoadminlangcount (collection_id, value) (% %) count updated, due to asset.name=% update.',\n            related_collection_id, asset_instance.geoadmin_lang, asset_instance.name;\n\n        RETURN asset_instance;\n        ",
                    hash='2f161a6fc23caf843e6cde830f6bf5f256562360',
                    operation='DELETE',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash='ccd9ac8c7595af31c56921af0171c9c6c14bc547',
                    operation='UPDATE',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    func=
                    "\n        asset_instance = OLD;\n\n        related_collection_id = (\n            SELECT collection_id FROM stac_api_item\n            WHERE id = asset_instance.item_id\n        );\n\n        UPDATE stac_api_geoadminvariantcount\n        SET count = count-1\n        WHERE collection_id = related_collection_id\n            AND value = asset_instance.geoadmin_variant;\n\n        RAISE INFO\n            'geoadminvariantcount (collection_id, value) (% %) count updated, due to asset.name=% update.',\n            related_collection_id, asset_instance.geoadmin_variant, asset_instance.name;\n\n        RETURN asset_instance;\n        ",
                    hash='b85dff71d9cd8e2e1a71b3c73d921a74175bbb73',
                    operation='DELETE',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash='c80f7d8afb7b2ea8e80e4f7c909abd9cff0c4579',
                    operation='UPDATE',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    func=
                    "\n        asset_instance = OLD;\n\n        related_collection_id = (\n            SELECT collection_id FROM stac_api_item\n            WHERE id = asset_instance.item_id\n        );\n\n        UPDATE stac_api_projepsgcount\n        SET count = count-1\n        WHERE collection_id = related_collection_id\n            AND value = asset_instance.proj_epsg;\n\n        RAISE INFO\n            'projepsgcount (collection_id, value) (% %) count updated, due to asset.name=% update.',\n            related_collection_id, asset_instance.proj_epsg, asset_instance.name;\n\n        RETURN asset_instance;\n        ",
                    hash='b742069a1e02013740f629c72ab25d15e798f8c7',
                    operation='DELETE',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash='55f5eaae4b0af8de60f8ef3438e9d013f1ff3a1a',
                    operation='UPDATE',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    func=
                    "\n        asset_instance = OLD;\n\n        related_collection_id = asset_instance.collection_id;\n\n        UPDATE stac_api_projepsgcount\n        SET count = count-1\n        WHERE collection_id = related_collection_id\n            AND value = asset_instance.proj_epsg;\n\n        RAISE INFO\n            'projepsgcount (collection_id, value) (% %) count updated, due to asset.name=% update.',\n            related_collection_id, asset_instance.proj_epsg, asset_instance.name;\n\n        RETURN asset_instance;\n        ",
                    hash='2218b2691243618ba48f692ff86733431a39f408',
                    operation='DELETE',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    condition='WHEN (OLD.count < 2 OR NEW.count < 2)',
                    declare=
                    ...
                    hash='04c3cc392e94cdb72bc8e953ed365687d64aace3',
                    operation='UPDATE',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash='5fa9e363a54c7f11683c91d59994d0d51ef80a15',
                    operation='UPDATE',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash='8bb11f97a096fed1c9329a8e0cc461d4fd305c17',
                    operation='UPDATE',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash='0b26c833f6e7ea2511eff818c91ab9fbf74e8630',
                    operation='UPDATE',
