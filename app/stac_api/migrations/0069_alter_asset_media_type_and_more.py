...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('stac_api', '0068_alter_asset_media_type_and_more'),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                [(
                 ...
                 ('application/x-hdf5',
                  'HDF5 (application/x-hdf5)'), ('application/x.aixm', 'AIXM (application/x.aixm)'),
                 ('application/x.aixm+zip', 'Zipped AIXM (application/x.aixm+zip)')],
                help_text=
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ('application/x.aixm', 'AIXM (application/x.aixm)'),
                    ('application/x.aixm+zip', 'Zipped AIXM (application/x.aixm+zip)')
                ],
                help_text=
                "This media type will be used as <em>Content-Type</em> header for the asset's object upon upload.",
